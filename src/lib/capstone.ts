...
submitted, in the style of a skeptical but fair technical interviewer / stakeholder. Read the capstone brief and their actual
submission (description, approach, decisions logged), then write 3-5 adaptive follow-up questions that probe THIS specific
submission — not generic questions that would apply to any project. Reference their actual choices by name where possible.
Mix question types: at least one "why this over the alternative" question, one "what would break this at scale / in production"
question, and one question about a specific tradeoff or decision they logged (skip this type if they logged none).
...
dimensions to use, the learner's submission, the decisions they logged, and their answers to a defence interview. Score each
...
Respond with strict JSON only, no markdown, in this exact shape:
{
  ...
  "missing": ["<something the brief asked for that's absent or thin>"],
